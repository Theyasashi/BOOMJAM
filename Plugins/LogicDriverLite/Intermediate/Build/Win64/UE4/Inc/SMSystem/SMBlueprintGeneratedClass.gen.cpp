...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_RootGuid_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_RootGuid;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USMBlueprintGeneratedClass_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Blueprints/SMBlueprintGeneratedClass.h" },
		{ "ModuleRelativePath", "Public/Blueprints/SMBlueprintGeneratedClass.h" },
	};
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USMBlueprintGeneratedClass_Statics::NewProp_RootGuid_MetaData[] = {
		{ "BlueprintCompilerGeneratedDefaults", "" },
		{ "ModuleRelativePath", "Public/Blueprints/SMBlueprintGeneratedClass.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_USMBlueprintGeneratedClass_Statics::NewProp_RootGuid = { "RootGuid", nullptr, (EPropertyFlags)0x0020080000000000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USMBlueprintGeneratedClass, RootGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UClass_USMBlueprintGeneratedClass_Statics::NewProp_RootGuid_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USMBlueprintGeneratedClass_Statics::NewProp_RootGuid_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USMBlueprintGeneratedClass_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USMBlueprintGeneratedClass_Statics::NewProp_RootGuid,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USMBlueprintGeneratedClass_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_USMBlueprintGeneratedClass()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_USMBlueprintGeneratedClass_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(USMBlueprintGeneratedClass, 2410832549);
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USMNodeBlueprintGeneratedClass_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Blueprints/SMBlueprintGeneratedClass.h" },
		{ "ModuleRelativePath", "Public/Blueprints/SMBlueprintGeneratedClass.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USMNodeBlueprintGeneratedClass_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_USMNodeBlueprintGeneratedClass()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_USMNodeBlueprintGeneratedClass_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(USMNodeBlueprintGeneratedClass, 3277201088);
