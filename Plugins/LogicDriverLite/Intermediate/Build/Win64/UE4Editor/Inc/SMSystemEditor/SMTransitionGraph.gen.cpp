...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USMTransitionGraph_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Graph/SMTransitionGraph.h" },
		{ "ModuleRelativePath", "Private/Graph/SMTransitionGraph.h" },
	};
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USMTransitionGraph_Statics::NewProp_ResultNode_MetaData[] = {
		{ "ModuleRelativePath", "Private/Graph/SMTransitionGraph.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_USMTransitionGraph_Statics::NewProp_ResultNode = { "ResultNode", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USMTransitionGraph, ResultNode), Z_Construct_UClass_USMGraphK2Node_TransitionResultNode_NoRegister, METADATA_PARAMS(Z_Construct_UClass_USMTransitionGraph_Statics::NewProp_ResultNode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USMTransitionGraph_Statics::NewProp_ResultNode_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USMTransitionGraph_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USMTransitionGraph_Statics::NewProp_ResultNode,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USMTransitionGraph_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_USMTransitionGraph()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_USMTransitionGraph_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(USMTransitionGraph, 2179700432);
