...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_GeneratedContainerNode_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_GeneratedContainerNode;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_TemporaryContainerGuid_MetaData[];
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_TemporaryContainerGuid;
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USMGraph_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Graph/SMGraph.h" },
		{ "ModuleRelativePath", "Private/Graph/SMGraph.h" },
	};
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USMGraph_Statics::NewProp_GeneratedContainerNode_MetaData[] = {
		{ "Comment", "// Set by compiler -- stored on consolidated graph.\n" },
		{ "ModuleRelativePath", "Private/Graph/SMGraph.h" },
		{ "ToolTip", "Set by compiler -- stored on consolidated graph." },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_USMGraph_Statics::NewProp_GeneratedContainerNode = { "GeneratedContainerNode", nullptr, (EPropertyFlags)0x0010000000002000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USMGraph, GeneratedContainerNode), Z_Construct_UClass_USMGraphK2Node_StateMachineEntryNode_NoRegister, METADATA_PARAMS(Z_Construct_UClass_USMGraph_Statics::NewProp_GeneratedContainerNode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USMGraph_Statics::NewProp_GeneratedContainerNode_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USMGraph_Statics::NewProp_EntryNode_MetaData[] = {
		{ "Comment", "// Entry node within the state machine\n" },
		{ "ModuleRelativePath", "Private/Graph/SMGraph.h" },
		{ "ToolTip", "Entry node within the state machine" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_USMGraph_Statics::NewProp_EntryNode = { "EntryNode", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USMGraph, EntryNode), Z_Construct_UClass_USMGraphNode_StateMachineEntryNode_NoRegister, METADATA_PARAMS(Z_Construct_UClass_USMGraph_Statics::NewProp_EntryNode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USMGraph_Statics::NewProp_EntryNode_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USMGraph_Statics::NewProp_TemporaryContainerGuid_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_USMGraph_Statics::NewProp_TemporaryContainerGuid = { "TemporaryContainerGuid", nullptr, (EPropertyFlags)0x0020080000002000, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USMGraph, TemporaryContainerGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UClass_USMGraph_Statics::NewProp_TemporaryContainerGuid_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USMGraph_Statics::NewProp_TemporaryContainerGuid_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_USMGraph_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USMGraph_Statics::NewProp_GeneratedContainerNode,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USMGraph_Statics::NewProp_EntryNode,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_USMGraph_Statics::NewProp_TemporaryContainerGuid,
	};
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_USMGraph_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_USMGraph()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_USMGraph_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(USMGraph, 3619633292);
